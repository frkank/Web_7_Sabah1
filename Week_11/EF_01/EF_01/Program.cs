    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            void BolumleriListele()
            {
                ...
                Console.WriteLine($"Bölüm ID\tBölümAd");
            ...
            void HizliAra()
            {
                using (HastaneAksamEntities hastane = new HastaneAksamEntities())
                {
                    ...
                    //Find sadece ilgili entititienin PK'i üzerinde arama yapar.
            ...
            //Doktorları Z'den A'ya adına göre sıralayalım
            ...
            //SORU: Diş bölümünde çalışan doktor adlarını A'dan Z'ye sıralı şekilde
            //listeleyin.
            void DisDoktorlariniSiralaAsc()
            {
                using (HastaneAksamEntities hastane = new HastaneAksamEntities())
                {
                    //ÖDEV: List<> ile ICollection<> arasındaki farkları araştırın.
                    var siraliDoktorlar = hastane.Doktorlar
                        .Where(a=> a.Bolumler.BolumAd=="Diş")
                        .OrderBy(x=>x.AdSoyad);
                    foreach (var doktor in siraliDoktorlar)
                    {
                        Console.WriteLine(doktor.AdSoyad);
            ...
            void BolumlereGoreDoktorSayisiniGoster()
            {
                using (HastaneAksamEntities hastane = new HastaneAksamEntities())
                {
                    ...
                    //Sadece count görmek istediğimizde name=y.Key satırını 
                    //kaldırdık.
