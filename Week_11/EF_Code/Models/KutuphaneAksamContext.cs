...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=DESKTOP-5JA1DBH;Database=KutuphaneAksam;Trusted_Connection=true;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Kitaplar>(entity =>
            {
                entity.HasKey(e => e.Isbn)
                    .HasName("PK__Kitaplar__447D36EBE9731E23");
            ...
            modelBuilder.Entity<Turler>(entity =>
            {
                ...
                entity.HasIndex(e => e.TurAd, "UQ__Turler__A1D0193DB9A3825C")
                    .IsUnique();
            ...
            modelBuilder.Entity<Yayinevleri>(entity =>
            {
                ...
                entity.HasIndex(e => e.Ad, "UQ__Yayinevl__3214AD0016C7B619")
                    .IsUnique();
